...
if(isset($_POST['submit'])){
	...
	if($password != $Cpassword){
		...
		$insert1="INSERT INTO `tbldonor` (nic,fname,lname,gender,age,telephone,email,address, occupation,username,password) VALUES ('$nic','$fname','$lname','$gender','$age','$telephone','$email','$address', '$occupation','$username','$password')";
								  ...
								  <!-- Nav tabs -->
								   <ul class="nav nav-tabs" role="tablist">
								      <li role="presentation" class="active">
								      	<a href="#flights" aria-controls="flights" role="tab" data-toggle="tab">Donor Registration</a>
								      </li>
										...
										<div class="row">
											...
											<div class="col-xxs-12 col-xs-6 mt alternate">
												<div class="input-field">
													...
													<input type="text" class="form-control" name="telephone" maxlength="10" minlength="10" oninvalid="setCustomValidity('Please enter correct Mobile Number.')" oninput="setCustomValidity('')" required/>
												</div>
											</div>
