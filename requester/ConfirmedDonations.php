...
<!DOCTYPE html>
	...
	<body>
		...
		<?php
			...
			$sql = "SELECT tblrequest.*, tbldonation.*, COUNT(tbldonation.Req_ID) AS count, tbldonor.* FROM tblrequest INNER JOIN tbldonation ON tblrequest.Request_ID = tbldonation.Req_ID INNER JOIN tbldonor ON tbldonation.Donor_ID = tbldonor.nic WHERE tbldonation.Requester_ID= '$nic' GROUP By tbldonation.Req_ID ";
