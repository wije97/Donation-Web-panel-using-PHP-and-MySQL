				...
				<div class="nav-header">
					...
					<nav id="fh5co-menu-wrap" role="navigation">
						<ul class="sf-menu" id="fh5co-primary-menu">
							...
							<li><a href="../updateinfoDonor.php">Update Profile</a></li>
				...
				<div class="row">
					<div class="col-md-4 col-sm-6 fh5co-tours animate-box" data-animate-effect="fadeIn">
						<div href="#"><img src="../images/place-15.jpg" class="img-responsive">
							<div class="desc">
								<span></span>
								<h3>View Requests</h3>
								<a class="btn btn-primary btn-outline" href="DonorrequestView.php">See Now<i class="icon-arrow-right22"></i></a>
					...
					<div class="col-md-4 col-sm-6 fh5co-tours animate-box" data-animate-effect="fadeIn">
						<div href="#"><img src="../images/place-18.jpg" class="img-responsive">
							<div class="desc">
								...
								<a class="btn btn-primary btn-outline" href="DonorSearchRequests.php">See Now<i class="icon-arrow-right22"></i></a>
					...
					<div class="col-md-4 col-sm-6 fh5co-tours animate-box" data-animate-effect="fadeIn">
						<div href="#"><img src="../images/place-16.jpg" class="img-responsive">
							<div class="desc">
								<span></span>
								<h3>Confirmed Donation</h3>
								<a class="btn btn-primary btn-outline" href="DonorConfirmedDonations.php">See Now<i class="icon-arrow-right22"></i></a>
