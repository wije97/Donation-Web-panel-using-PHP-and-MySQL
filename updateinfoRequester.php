<?php
	...
	if ($logtype == "requester") {
		$sql = "select *from tblrequester where nic = '$nics'";
	...
	if(isset($_POST['submit'])){
		...
		$occupation = $_POST['occupation'];
			...
			$insert1 = "UPDATE `tblrequester` SET  fname='$fname',lname='$lname',gender='$gender',age='$age',telephone='$telephone',email='$email',address='$address',occupation='$occupation' WHERE nic='$nics'";
			...
			if($query == 1){		
				...
				if($usertype == "requester"){
					...
					window.location.href = "updateinfoRequester.php";</script>';
				}else {
					echo '<script type="text/javascript">
					alert("Update Successful !");
	...
	if(isset($_POST['back'])){
		if($usertype == "requester"){
			echo '<script type="text/javascript">window.location.href = "requester/Requester_UI.php";</script>';
		}else {
								  ...
								  <!-- Nav tabs -->
								   <ul class="nav nav-tabs" role="tablist">
								      <li role="presentation" class="active">
								      	<a href="#flights" aria-controls="flights" role="tab" data-toggle="tab"><?php if($usertype == "admin") {?> View Requester Details <?php }else {?> Update Requester Details <?php }  ?></a>
								      </li>
									...
									<div class="tab-content">
									 <div role="tabpanel" class="tab-pane active" id="flights">
										<div class="row">
											...
											<div class="col-xxs-12 col-xs-6 mt alternate">
												<input type="submit" class="btn btn-primary1 btn-block" value="BACK" name="back" >
											</div>
											<?php if($usertype != "admin") {?> 
												<div class="col-xxs-12 col-xs-6 mt alternate">
