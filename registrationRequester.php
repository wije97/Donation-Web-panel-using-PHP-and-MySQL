<?php
	...
	if(isset($_POST['submit'])){
		...
		if($password != $Cpassword){
			...
			$insert1="INSERT INTO `tblrequester` (nic,fname,lname,gender,age,occupation,telephone,email,address,username,password) VALUES ('$nic','$fname','$lname','$gender','$age','$occupation','$telephone','$email','$address','$username','$password')";
								  ...
								  <!-- Nav tabs -->
								   <ul class="nav nav-tabs" role="tablist">
								      <li role="presentation" class="active">
								      	<a href="#flights" aria-controls="flights" role="tab" data-toggle="tab">Requester Registration</a>
								      </li>
