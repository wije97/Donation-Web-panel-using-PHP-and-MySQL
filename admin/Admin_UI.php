<?php
	...
	$sql = "SELECT * FROM tblauthorizer WHERE status ='Pending'";
					...
					<div class="col-md-4 col-sm-6 fh5co-tours animate-box" data-animate-effect="fadeIn">
						<div href="#"><img <?php if($rowcount > 0) {?> src="../images/place-14-red.jpg" <?php }else {?> src="../images/place-14-grey.jpg" <?php }  ?> class="img-responsive">
							<div class="desc">
								...
								<a class="btn btn-primary btn-outline" href="AdminAuthorizerApprove.php">see Now <i class="icon-arrow-right22"></i></a>
